...
export default function ProductCard() {
    ...
    return (
        <div className="w-[170px] h-fit md:w-[280px] p-1 font-raleway hover:shadow-2xl hover:scale-101 duration-300">
            <img src="product-img.jpg" className="w-full h-[170px] md:h-[280px] object-cover"  alt="" />
